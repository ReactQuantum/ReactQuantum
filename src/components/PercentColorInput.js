    ...
    return (
      <form style={{ borderBottom: '0.5px solid #ababab', boxShadow: '0 4px 2px -2px #ababab', paddingBottom: '5px' }}>
        <div style={{ width: '98%', display: 'inline', justifyContent: 'left' }}>
          <p>Node colors are determined by lowest input percentage above individual render time, divided by total render time of app. Nodes will appear red otherwise.</p>
